...
public class AStar {
    ...
    public static String test2(){
        V8 v8 = V8.createV8Runtime();
        v8.executeVoidScript(astarjs);
        V8Array param = new V8Array(v8);
        Object test = v8.getObject("ttt");
...
//        v8.executeVoidScript(astarjs);
//        V8Array param = new V8Array(v8);
//        V8Object test = v8.getObject("mytest");
//        V8Array r2 = test.executeArrayFunction("test2", param);
//        for(int i=0;i<r2.length();i++){
//            V8Object item = r2.getObject(i);
